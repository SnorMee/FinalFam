...
function createTreeData(data, type, fam, word){
    let TH = {}
    let t = type
    let numTot = 0
    let numSpe = 0
...
function createTreeDataNumbers1(data, type, fam, word){
    let TH = {}
    let t = type
    let numTot = 0
    let numSpe = 0
...
function createTreeDataNumbers2(data, type, fam, word){
    let TH = {}
    let t = type
    let numTot = 0
    let numSpe = 0
...
const searchBar = document.getElementById('search-bar');
  ...
  function search(text) {
    ...
    let TreeDict = createTreeData(dataThreatTotal,dataThreatType,dataFamily,selectedWord);
    let TreeNum1 = createTreeDataNumbers1(dataThreatTotal,dataThreatType,dataFamily,selectedWord);
    let TreeNum2 = createTreeDataNumbers2(dataThreatTotal,dataThreatType,dataFamily,selectedWord);
